    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', filer.fields.image.FilerImageField(verbose_name='image', blank=True, to='filer.Image',on_delete=models.SET_NULL, null=True)),
                ('page_link', cms.models.fields.PageField(blank=True, to='cms.Page',on_delete=models.SET_NULL, help_text='A link to a page has priority over a text link.', null=True, verbose_name='Page')),
            ],
            options={
                'abstract': False,
            },
